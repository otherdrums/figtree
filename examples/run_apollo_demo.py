...
Phase 1 (ingest):  python3 run_apollo_demo.py ingest
Phase 2 (generate): python3 run_apollo_demo.py generate
...
from pdga.apollo.streaming import StreamingGenerator
...
def do_ingest():
    ...
    db.close()
    console.print("\n[bold green]Ingestion complete.[/bold green] Run: python3 run_apollo_demo.py generate")
